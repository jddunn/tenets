...
### Core Components
- **[Tenets](.)** - Main package and API
- **[Config](tenets/config)** - Configuration system  
- **[API](tenets/api)** - Public API interface
- **[Core](tenets/core/)** - Core functionality package

### Core Modules
- **[Analysis](tenets/core/analysis/)** - Code analysis package
- **[Distiller](tenets/core/distiller/)** - Context distillation package
- **[Instiller](tenets/core/instiller/)** - Session and file injection
- **[Examiner](tenets/core/examiner/)** - Code examination tools
- **[Git](tenets/core/git/)** - Git integration
- **[Momentum](tenets/core/momentum/)** - Development velocity tracking
- **[NLP](tenets/core/nlp/)** - Natural language processing
- **[Prompt](tenets/core/prompt/)** - Prompt management
- **[Ranking](tenets/core/ranking/)** - File ranking system
  - **[Ranker](tenets/core/ranking/ranker)** - Main ranking engine
  - **[Strategies](tenets/core/ranking/strategies)** - Ranking strategies
  - **[Factors](tenets/core/ranking/factors)** - Ranking factors
- **[Reporting](tenets/core/reporting/)** - Report generation
- **[Session](tenets/core/session/)** - Session management
- **[Summarizer](tenets/core/summarizer/)** - Content summarization

### Command Line Interface
- **[CLI Package](tenets/cli/)** - Command-line tools
- **[App](tenets/cli/app)** - CLI application
- **[Commands Package](tenets/cli/commands/)** - Available commands

### Data Models
- **[Models Package](tenets/models/)** - Data models package
...
### Storage & Utilities
- **[Storage Package](tenets/storage/)** - Caching and persistence
- **[Cache](tenets/storage/cache)** - Cache system
- **[Utils Package](tenets/utils/)** - Utility functions
- **[Viz Package](tenets/viz/)** - Visualization tools

## Key Classes

| Class | Module | Link |
|-------|--------|------|
| `Tenets` | tenets | **[View Documentation →](.)** |
| `Distiller` | tenets.core.distiller | **[View Documentation →](tenets/core/distiller/)** |
| `Instiller` | tenets.core.instiller.instiller | **[View Documentation →](tenets/core/instiller/instiller)** |
...
| `Examiner` | tenets.core.examiner | **[View Documentation →](tenets/core/examiner/)** |
