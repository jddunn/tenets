...
def show_instruction(
    ...
    try:
        ...
        if raw:
            ...
            if any(keyword in instruction.lower() for keyword in ['def ', 'class ', 'function', 'import']):
    ...
    try:
        ...
        if check_tokens:
            ...
            if estimated_tokens > max_tokens:
                issues.append(f"Estimated tokens ({int(estimated_tokens)}) exceeds max ({max_tokens})")
