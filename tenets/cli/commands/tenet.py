...
tenet_app = typer.Typer(
    help="Manage guiding principles (tenets)",
...
def add_tenet(
    ...
    priority: str = typer.Option(
        "medium",
        "--priority", "-p",
        help="Priority level: low, medium, high, critical"
    ),
...
def export_tenets(
    ...
    session: Optional[str] = typer.Option(None, "--session", "-s", help="Export session-specific tenets"),
    include_archived: bool = typer.Option(False, "--include-archived", help="Include archived tenets"),
):
...
def import_tenets(
    ...
    session: Optional[str] = typer.Option(None, "--session", "-s", help="Import into specific session"),
