...
class LightweightAnalysis:
    ...
    def to_file_analysis(self) -> FileAnalysis:
        ...
        return FileAnalysis(
            ...
            last_modified=datetime.fromtimestamp(self.last_modified),  # Convert timestamp to datetime
...
class LightweightAnalyzer:
    ...
    TEST_INDICATORS = {
        ...
        'tests/', 'test/', '__tests__/', 'specs/',
        'unittest', 'pytest', 'jest', 'mocha',
    ...
    def _extract_keywords(self, content: str) -> Set[str]:
        ...
        common_keywords = {
            'the', 'and', 'for', 'if', 'else', 'return', 'def', 'class',
            'function', 'var', 'let', 'const', 'import', 'from', 'export',
            'public', 'private', 'static', 'void', 'int', 'string', 'bool',
            'true', 'false', 'null', 'none', 'self', 'this', 'new', 'try',
            'catch', 'throw', 'async', 'await', 'with', 'while', 'break',
        }
