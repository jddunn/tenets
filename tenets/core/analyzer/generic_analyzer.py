...
from tenets.core.analysis.base import LanguageAnalyzer
...
class GenericAnalyzer(LanguageAnalyzer):
    ...
    def calculate_complexity(self, content: str, file_path: Path) -> ComplexityMetrics:
        ...
        decision_keywords = [
            r'\bif\b', r'\belse\b', r'\belif\b', r'\belsif\b',
            r'\bfor\b', r'\bwhile\b', r'\bdo\b', r'\bcase\b',
            r'\bwhen\b', r'\btry\b', r'\bcatch\b', r'\bexcept\b',
            r'\bunless\b', r'\buntil\b', r'\bswitch\b',
            r'\b\?\s*[^:]+\s*:', r'\|\|', r'&&', r'\band\b', r'\bor\b'
        ]
    ...
    def _detect_file_type(self, file_path: Path) -> str:
        ...
        config_extensions = ['.json', '.yaml', '.yml', '.toml', '.ini', '.conf', 
                           '.cfg', '.properties', '.env']
        config_names = ['config', 'settings', 'preferences', '.env', 'dockerfile',
        ...
        markup_extensions = ['.md', '.markdown', '.rst', '.tex', '.html', '.xml',
                           '.sgml', '.xhtml', '.svg']
    ...
    def _analyze_indentation(self, content: str) -> Dict[str, Any]:
        ...
        return {
            ...
            'max_level': max(indent_sizes) // indent_size if indent_size > 0 and indent_sizes else 0
        }
