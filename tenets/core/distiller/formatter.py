    ...
    def _format_html(
        ...
        <script>
            ...
            function copyAllPaths() {
                const paths = [];
                const files = window.contextData.included_files || [];
                files.forEach(file => {
                    if (file.file && file.file.path) {
                        paths.push(file.file.path);
                    }
                });
        ...
        if metadata.get("start_time"):
            try:
                ...
                execution_time_str = f"<p>Execution time: {exec_time:.2f} seconds</p>"
            except:
                pass
        ...
        <div class="tab-container">
            <div class="tab-nav">
                ...
                <div class="tab-controls">
                    ...
                    <button class="export-button" id="copy-all-paths" onclick="copyAllPaths()">📂 All Paths</button>
                </div>
            </div>
        </div>
        """
