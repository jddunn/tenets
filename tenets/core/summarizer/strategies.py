...
class TextRankStrategy(SummarizationStrategy):
    ...
    def __init__(self, use_nlp: bool = True):
        ...
        if not SKLEARN_AVAILABLE:
            raise ImportError("TextRank requires scikit-learn. Install with: pip install scikit-learn")
...
class NLPEnhancedStrategy(SummarizationStrategy):
    ...
    def summarize(
        ...
        selected = self._select_diverse_sentences(
            sentences, scores, target_length, min_length
        )
