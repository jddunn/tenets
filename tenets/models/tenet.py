...
class Tenet:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'metrics': {
                ...
                'last_injected': self.metrics.last_injected.isoformat() if self.metrics.last_injected else None,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Tenet":
        ...
        instilled_at = datetime.fromisoformat(data['instilled_at']) if data.get('instilled_at') else None
