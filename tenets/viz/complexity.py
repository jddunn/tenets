...
class ComplexityHeatmap(VisualizationBase):
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'avg_maintainability': sum(f.maintainability_index for f in self.files) / len(self.files)
        }
    ...
    def _render_ascii(self) -> str:
        ...
        for f in sorted_files:
            ...
            bar_length = int(f.cyclomatic / self.max_complexity * 30) if self.max_complexity > 0 else 0
            bar = "█" * bar_length
    ...
    def _render_svg(self, width: int, height: int, dpi: int) -> str:
        ...
        if self.files:
            ...
            scatter = ax1.scatter(x, y, c=colors, cmap='RdYlGn_r', 
