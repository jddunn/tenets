...
class TestStopwordSet:
    ...
    def test_initialization(self):
        ...
        stopword_set = StopwordSet(name="test", words=words, description="Test stopwords")
    ...
    def test_contains(self):
        ...
        stopword_set = StopwordSet(name="test", words={"the", "a", "an"}, description="Test")
    ...
    def test_filter(self):
        ...
        stopword_set = StopwordSet(name="test", words={"the", "a", "is"}, description="Test")
...
class TestStopwordManager:
    ...
    def test_add_custom_set(self):
        ...
        custom_set = manager.add_custom_set(
            name="custom", words=custom_words, description="Custom stopwords"
        )
    ...
    def test_load_from_file(self, tmp_path):
        ...
        loaded_set = manager._load_set_from_file(stopword_file, name="test", description="Test set")
    ...
    def test_case_insensitive(self):
        ...
        custom_set = manager.add_custom_set("test", {"The", "A", "AN"}, "Test")  # Mixed case
