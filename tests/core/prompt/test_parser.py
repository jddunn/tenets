...
class TestPromptParser:
    ...
    def test_fetch_external_content_github(self, mock_get, parser):
        ...
        ref = ExternalReference(
            ...
            metadata={"owner": "owner", "repo": "repo", "number": "123", "type": "issues"},
        )
    ...
    def test_enhance_with_context(self, parser):
        ...
        context = PromptContext(
            text="original prompt", keywords=["keyword1"], focus_areas=["area1"]
        )
    ...
    def test_error_handling_in_external_fetch(self, parser):
        ...
        with patch("requests.get") as mock_get:
            ...
            ref = ExternalReference(type="url", url="https://example.com", identifier="test")
