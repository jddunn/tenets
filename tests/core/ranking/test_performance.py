...
from tenets.core.ranking.ml_config import MLConfig, get_optimal_ml_config
...
class TestPerformanceHierarchy:
    ...
    def test_no_quadratic_complexity(self, prompt_context):
        ...
        assert ratio_variance < 0.5, f"High variance {ratio_variance:.2f} suggests non-linear complexity"
...
class TestPerformanceMonitoring:
    ...
    def test_performance_warnings(self, caplog):
        ...
        assert any("Performance warning" in msg for msg in warnings), f"Expected performance warning, got: {warnings}"
...
class TestPerformanceRegression:
    ...
    def test_balanced_mode_performance_target(self):
        ...
        context = PromptContext(
            text="balanced scoring",
            keywords=["balanced", "scoring"],
            task_type="general"
        )
